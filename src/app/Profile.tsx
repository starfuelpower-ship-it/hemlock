  ...
  return (
    <PageShell>
      ...
      <div className="mt-4 g-panel p-6">
        <div className="text-2xl font-semibold g-emboss">Profile</div>
        <div className="mt-2 text-zinc-300">Profile placeholder. Stats, ranks, risk/protection, identity.</div>
      </div>
    </PageShell>
  );
}
